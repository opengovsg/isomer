...
// Prototype only: the three number treatments under evaluation. Production
// should settle on one and drop this field so numbering stays consistent
// across all Isomer sites.
