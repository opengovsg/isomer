  ...
  return (
    ...
    >
          ...
          <div className="flex flex-wrap items-start gap-x-1 pt-1.5">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`block h-[21px] w-[12px] select-none self-center transition-all delay-0 duration-300 ease-in-out ${
      ...
      <div
        ...
        className={`px-3 pb-8 pt-4 text-[#474747] lg:container lg:px-6 lg:pb-12 lg:pt-10 ${
