  ...
  return (
    ...
    >
      <div className="px-3 lg:container lg:px-6">
        <div className="flex gap-1">
          <svg
            ...
            height="32"
            viewBox="0 0 32 32"
            className="h-7 w-5 shrink-0 align-top has-[path]:fill-[#ef3320]"
          >
          ...
          <div className="flex flex-wrap items-start gap-x-1 pt-1.5">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`block h-[21px] w-[12px] self-center transition-all delay-0 duration-300 ease-in-out select-none ${
      ...
      <div
        ...
        className={`px-3 pt-4 pb-8 text-[#474747] lg:container lg:px-6 lg:pt-10 lg:pb-12 ${
