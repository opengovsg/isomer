...
const createSearchableTableStyles = tv({
  slots: {
    ...
    emptyStateTitle: "prose-title-lg-regular",
    emptyStateSubtitle:
            ...
            {isFilteredEmpty && (
              <div className={compoundStyles.emptyState()}>
                <div className={compoundStyles.emptyStateHeadings()}>
                  <p
                    className={compoundStyles.emptyStateTitle({ bold: false })}
                  >
                    No search results for “
                    <b
                      className={compoundStyles.emptyStateTitle({ bold: true })}
                    >
                      {search}
                    </b>
                    ”
                  ...
                  <p className={compoundStyles.emptyStateSubtitle()}>
                    Check if you have a spelling error or try a different search
                    term.
                  </p>
                </div>
