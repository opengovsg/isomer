...
const RestrictedHeaderBar = ({
  ...
  desktopButtonClassNames,
}: RestrictedHeaderBarProps) => {
        ...
        className={composeRenderProps(
          ...
          (className, renderProps) => {
            if (renderProps.isFocusVisible) {
              return `${mobileButtonClassNames.focusVisible} ${className}`
            }
            return `${mobileButtonClassNames.base} ${className}`
          },
        )}
        ...
        <RestrictedHeaderBarContent>
          <Button
            className={composeRenderProps(
              ...
              (className, renderProps) => {
                if (renderProps.isFocusVisible) {
                  return `${desktopButtonClassNames.focusVisible} ${className}`
                }
                return `${desktopButtonClassNames.base} ${className}`
              },
            )}
            onPress={toggleMastheadContent}
          >
