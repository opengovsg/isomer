...
interface MastheadProviderProps {
...
const MastheadProvider = ({
  ...
  return (
    <MastheadContext.Provider
      value={{ isMastheadContentVisible, toggleMastheadContent, LinkComponent }}
    >
      {children}
    </MastheadContext.Provider>
  )
...
const RestrictedHeaderBar = ({ children }: PropsWithChildren) => {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-6 lg:px-10">
      ...
      <div className="hidden items-center gap-1 lg:flex">{children}</div>
    </div>
  )
}
          ...
          <div>
            ...
            <article className="leading-[1.2rem] lg:leading-6">
              ...
              <Link
                ...
                className="inline-flex items-center text-brand-interaction hover:text-brand-interaction-hover"
                rel="noreferrer"
                target="_blank"
              >
                Trusted websites
...
export const Masthead = ({
  ...
  return (
    <MastheadProvider LinkComponent={LinkComponent}>
      <div className="bg-[#f0f0f0] text-[0.875rem]">
        <RestrictedHeaderBar>
          <svg
            ...
            height="32"
            viewBox="0 0 32 32"
            className="h-7 w-5 flex-shrink-0 has-[path]:fill-[#ef3320]"
          >
