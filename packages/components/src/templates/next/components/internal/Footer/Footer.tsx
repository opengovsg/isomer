...
const ContactUsSection = ({
  ...
  <div className="prose-body-sm flex flex-col gap-3">
    {hasNonEmptyString(contactUsLink) && (
      <FooterItem
        title="Contact"
        url={
          getReferenceLinkHref(
    ...
    {hasNonEmptyString(feedbackFormLink) && (
      <FooterItem
        title="Feedback"
        url={
          getReferenceLinkHref(
  ...
  <div className="flex h-full">
    <div className="flex flex-col justify-end gap-4 lg:gap-2">
      <p className="prose-label-md-regular text-base-content-inverse-subtle">
        <ClientCopyrightYear />{" "}
        {isGovernment === true ? "Government of Singapore" : agencyName}, last
      ...
      <div className="prose-body-sm flex flex-col gap-3 lg:flex-row lg:gap-8">
        ...
        {hasNonEmptyString(privacyStatementLink) && (
          <FooterItem
        ...
        {hasNonEmptyString(termsOfUseLink) && (
          <FooterItem
            title="Terms of Use"
            url={
              getReferenceLinkHref(
