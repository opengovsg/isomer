...
export const Simple: Story = {
  args: {
    content: [
      {
        content: [
          { content: [{ text: "Item 1", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
      {
        content: [
          { content: [{ text: "Item 2", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
      {
        content: [
          { content: [{ text: "Item 3", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
      {
      ...
      {
        content: [
          { content: [{ text: "Item 5", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
      {
...
export const Nested: Story = {
  args: {
    content: [
      ...
      {
        content: [
          { content: [{ text: "Item 8", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
    ],
...
export const NonStandardStart: Story = {
  args: {
    ...
    content: [
      ...
      {
        content: [
          { content: [{ text: "Item 4", type: "text" }], type: "paragraph" },
        ],
        type: "listItem",
      },
      {
