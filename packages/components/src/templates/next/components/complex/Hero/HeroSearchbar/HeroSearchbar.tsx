...
export const HeroSearchbar = (props: HeroSearchbarProps) => {
  ...
  if (backgroundUrl) {
    ...
    return (
      <section className="relative flex min-h-80 w-full flex-col justify-center text-base-content-inverse before:absolute before:inset-0 before:z-10 before:bg-[#182236] before:opacity-80 lg:min-h-96">
        <div
