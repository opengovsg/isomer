...
export const HeroSearchbar = (props: HeroSearchbarProps) => {
  ...
  if (backgroundUrl) {
    ...
    return (
      <section className="flex-col relative flex w-full justify-center text-base-content-inverse before:absolute before:inset-0 before:z-10 before:bg-[#182236] before:opacity-80 md:min-h-80 lg:min-h-96">
        <div
    ...
    return (
      <section
        className="flex-col flex w-full justify-center text-base-content-strong md:min-h-80 lg:min-h-96"
        style={{
          background:
