...
export const HeroFloating = ({
  ...
  return (
    <section
      ...
      className={twMerge(
        ComponentContent,
        "flex w-full flex-col items-center px-0! pt-6 pb-12 sm:px-0! md:px-0! md:pt-16 md:pb-24 lg:items-start lg:px-10!",
      )}
    >
      ...
      {/* Floating container */}
      <div className="-mt-6 w-full max-w-[calc(100%-3rem)] md:-mt-40 md:max-w-[calc(100%-5rem)] lg:mt-[-17.85rem] lg:max-w-none">
        <div
          className={twMerge(
            "flex w-full flex-col gap-9 px-4 py-6 md:gap-[38px] md:p-12 lg:max-w-[66.67%]",
            heroColour,
          )}
        >
          {/* Text container */}
          ...
          >
            <h1 className={twMerge("prose-display-xl", heroTitleColour)}>
              {title}
            </h1>
            {subtitle && (
              <p
