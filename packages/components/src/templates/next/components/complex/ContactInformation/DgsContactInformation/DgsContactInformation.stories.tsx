...
const DgsParameters = {
  msw: {
    handlers: [
      http.get(DgsUrl, () => HttpResponse.json(DEFAULT_MOCK_RESPONSE)),
    ],
  },
}
...
export const EmptyOtherInformation: Story = {
  parameters: {
    msw: {
      handlers: [
        http.get(DgsUrl, () =>
          HttpResponse.json({
            ...
            result: {
              ...DEFAULT_MOCK_RESPONSE.result,
              records: [
                {
                  ...DEFAULT_MOCK_RESPONSE.result.records[0],
                  other_information: JSON.stringify({
