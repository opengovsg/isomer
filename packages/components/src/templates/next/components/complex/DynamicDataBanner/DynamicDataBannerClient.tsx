...
const createDynamicDataBannerStyles = tv({
  slots: {
    ...
    dataInfoContainer:
      "grid grid-cols-3 max-md:justify-items-center max-md:gap-y-4 md:justify-items-end md:gap-y-2 md:max-lg:grid-cols-[auto,auto,auto] md:max-lg:gap-x-6 lg:flex lg:gap-11",
