...
const createDynamicDataBannerStyles = tv({
  slots: {
    ...
    dataInfoContainer:
      "md:max-lg:col-gap-10 md:max-lg:grid-cols-[auto,auto,auto] md:max-lg:gap-x-6 grid grid-cols-3 justify-items-center gap-y-4 md:justify-items-end md:gap-y-2 lg:flex lg:gap-11",
