...
const createBoxStyles = tv({
  slots: {
    ...
    image: "rounded-t-lg bg-white",
    textContainer:
      "col-span-full row-span-1 flex flex-col gap-2 break-words px-5 pb-5",
    contentContainer:
      "grid-rows-[1fr fit-content] group grid cursor-pointer grid-cols-subgrid content-start items-start gap-y-5 rounded-lg border border-base-divider-medium max-md:col-span-full md:col-span-3",
    title: [
      groupFocusVisibleHighlight(),
