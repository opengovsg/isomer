...
describe(isSupportedBrowser, () => {
  it("should identify Chrome 63 as outdated", () => {
    ...
    expect(isSupportedBrowser({ userAgent })).toBeFalsy()
  })

  it("should identify Chrome 64 as not outdated", () => {
    const userAgent =
      "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36"
    expect(isSupportedBrowser({ userAgent })).toBeTruthy()
  })
  ...
  it("should return false for unknown browsers", () => {
    ...
    expect(isSupportedBrowser({ userAgent: unknownUserAgent })).toBeFalsy()
  })

  // fail-safe cases
  it("should return true if no userAgent is provided", () => {
    expect(isSupportedBrowser({})).toBeTruthy()
  })
  ...
  it("should return true if userAgent is undefined", () => {
    expect(isSupportedBrowser({ userAgent: undefined })).toBeTruthy()
  })

  // fail-safe cases
  it("should return true if userAgent is null", () => {
    expect(isSupportedBrowser({ userAgent: null })).toBeTruthy()
  })
})
