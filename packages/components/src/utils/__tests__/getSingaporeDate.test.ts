...
describe("getSingaporeDateYYYYMMDD", () => {
  ...
  it("keeps the UTC calendar date when still the same day in Singapore", () => {
    // 2026-06-15 12:00 UTC = 2026-06-15 20:00 SGT
    const date = new Date("2026-06-15T12:00:00.000Z")

    expect(getSingaporeDateYYYYMMDD(date)).toEqual("2026-06-15")
  })
