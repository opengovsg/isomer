...
| `@isomer/oxlint-config/vitest`  | `vitest.ts` — Ultracite vitest with strict `toBe(true/false)` matchers and a custom plugin that bans placeholder `toThrow(/./)` matchers   |
