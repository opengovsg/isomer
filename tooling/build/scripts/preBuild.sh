...
curl https://raw.githubusercontent.com/opengovsg/isomer/zhongjun/test/tooling/template/tailwind.config.js -o tailwind.config.js
...
curl https://raw.githubusercontent.com/opengovsg/isomer/zhongjun/test/tooling/build/scripts/generate-sitemap.js -o scripts/generate-sitemap.js
