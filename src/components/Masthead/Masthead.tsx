...
export const Masthead = ({ isStaging }: MastheadProps) => {
  ...
  return (
    <>
      <div
        id="sgds-masthead"
        className="bg-[#f0f0f0] text-[0.6875rem] text-[#717171] lg:text-sm"
        ...
        <div className="lg:container lg:px-6 px-3">
          <div className="flex items-center gap-1">
            <svg
              ...
              height="32"
              viewBox="0 0 32 32"
              className="w-5 h-7 has-[path]:fill-[#ef3320]"
            >
            ...
            <div
              className="flex text-[#2f5fd0] items-center cursor-pointer"
            ...
            >
              <span className="underline hover:text-[#4371d6] mr-1">
                How to identify
              </span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex gap-2 lg:gap-4 text-[0.6875rem] lg:text-base">
              <div className="lg:mt-[0.2rem] -mt-[0.1rem]">
                <svg
                  ...
                  viewBox="0 0 17 17"
                  fill="none"
                  className="w-3 lg:w-[1.125rem] has-[path]:fill-[#242425]"
                >
              ...
              <div>
                <div className="font-semibold mb-1 lg:mb-2">
                ...
                <article className="leading-[1.2rem] lg:leading-6">
                  ...
                  >
                    ...
                    <svg
                      ...
                      height="18"
                      viewBox="0 0 32 32"
                      className="w-3 lg:w-auto ml-0.5 fill-[#2f5fd0] hover:fill-[#4371d6]"
                    >
            ...
            <div className="flex gap-2 lg:gap-4 text-[0.6875rem] lg:text-base">
              <div className="-mt-[0.1rem]">
                <svg
                  ...
                  viewBox="0 0 15 18"
                  fill="none"
                  className="w-3 lg:w-[1.125rem] has-[path]:fill-[#242425] inline-block"
                >
              ...
              <div>
                ...
                <article>
                  ...
                  <svg
                    ...
                    viewBox="0 0 15 18"
                    fill="none"
                    className="has-[path]:fill-[#242425] w-[0.6rem] lg:w-auto h-[0.6rem] lg:h-auto mb-[0.1875rem] inline-block"
                  >
                    <path d="M14.1663 9.00008C14.1663 8.08091 13.4188 7.33342 12.4997 7.33342H11.6663V4.83342C11.6663 2.53591 9.79717 0.666748 7.49967 0.666748C5.20217 0.666748 3.33301 2.53591 3.33301 4.83342V7.33342H2.49967C1.58051 7.33342 0.833008 8.08091 0.833008 9.00008V15.6667C0.833008 16.5859 1.58051 17.3334 2.49967 17.3334H12.4997C13.4188 17.3334 14.1663 16.5859 14.1663 15.6667V9.00008ZM4.99967 4.83342C4.99967 3.45508 6.12134 2.33341 7.49967 2.33341C8.87801 2.33341 9.99967 3.45508 9.99967 4.83342V7.33342H4.99967V4.83342Z"></path>
                  </svg>
