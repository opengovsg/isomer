...
| [packages/components/src/templates/next/layouts/Search/Search.stories.tsx](/packages/components/src/templates/next/layouts/Search/Search.stories.tsx) | TypeScript JSX | -67 | -2 | -10 | -79 |
...
| [packages/components/src/templates/next/layouts/Skeleton/Skeleton.tsx](/packages/components/src/templates/next/layouts/Skeleton/Skeleton.tsx) | TypeScript JSX | -44 | 0 | -7 | -51 |
| [packages/components/src/templates/next/layouts/Skeleton/index.ts](/packages/components/src/templates/next/layouts/Skeleton/index.ts) | TypeScript | -1 | 0 | -1 | -2 |
| [packages/components/src/templates/next/layouts/index.ts](/packages/components/src/templates/next/layouts/index.ts) | TypeScript | -6 | 0 | -1 | -7 |
| [packages/components/src/templates/next/render/index.ts](/packages/components/src/templates/next/render/index.ts) | TypeScript | -2 | 0 | -1 | -3 |
| [packages/components/src/templates/next/render/render.tsx](/packages/components/src/templates/next/render/render.tsx) | TypeScript JSX | -84 | -1 | -4 | -89 |
| [packages/components/src/templates/next/render/renderPageContent.ts](/packages/components/src/templates/next/render/renderPageContent.ts) | TypeScript | -22 | 0 | -2 | -24 |
| [packages/components/src/templates/next/types/CollectionSearch.ts](/packages/components/src/templates/next/types/CollectionSearch.ts) | TypeScript | -6 | 0 | -2 | -8 |
| [packages/components/src/templates/next/types/CollectionSort.ts](/packages/components/src/templates/next/types/CollectionSort.ts) | TypeScript | -11 | 0 | -3 | -14 |
| [packages/components/src/templates/next/types/Filter.ts](/packages/components/src/templates/next/types/Filter.ts) | TypeScript | -28 | 0 | -7 | -35 |
| [packages/components/src/templates/next/types/Pagination.ts](/packages/components/src/templates/next/types/Pagination.ts) | TypeScript | -7 | 0 | -2 | -9 |
| [packages/components/src/types/components.ts](/packages/components/src/types/components.ts) | TypeScript | -49 | 0 | -8 | -57 |
| [packages/components/src/types/index.ts](/packages/components/src/types/index.ts) | TypeScript | -5 | 0 | -1 | -6 |
| [packages/components/src/types/page.ts](/packages/components/src/types/page.ts) | TypeScript | -137 | 0 | -13 | -150 |
| [packages/components/src/types/schema.ts](/packages/components/src/types/schema.ts) | TypeScript | -152 | 0 | -17 | -169 |
| [packages/components/src/types/site.ts](/packages/components/src/types/site.ts) | TypeScript | -26 | 0 | -5 | -31 |
| [packages/components/src/types/sitemap.ts](/packages/components/src/types/sitemap.ts) | TypeScript | -30 | 0 | -4 | -34 |
| [packages/components/src/types/utils.ts](/packages/components/src/types/utils.ts) | TypeScript | -1 | 0 | -1 | -2 |
| [packages/components/src/utils/getBreadcrumbFromSiteMap.ts](/packages/components/src/utils/getBreadcrumbFromSiteMap.ts) | TypeScript | -30 | -3 | -6 | -39 |
| [packages/components/src/utils/getDigestFromText.ts](/packages/components/src/utils/getDigestFromText.ts) | TypeScript | -4 | 0 | -2 | -6 |
| [packages/components/src/utils/getFormattedDate.ts](/packages/components/src/utils/getFormattedDate.ts) | TypeScript | -7 | 0 | -1 | -8 |
| [packages/components/src/utils/getRandomNumber.ts](/packages/components/src/utils/getRandomNumber.ts) | TypeScript | -3 | 0 | -1 | -4 |
| [packages/components/src/utils/getSanitizedIframeWithTitle.ts](/packages/components/src/utils/getSanitizedIframeWithTitle.ts) | TypeScript | -31 | -3 | -5 | -39 |
| [packages/components/src/utils/getSanitizedInlineContent.ts](/packages/components/src/utils/getSanitizedInlineContent.ts) | TypeScript | -33 | -4 | -6 | -43 |
| [packages/components/src/utils/getSitemapAsArray.ts](/packages/components/src/utils/getSitemapAsArray.ts) | TypeScript | -15 | 0 | -4 | -19 |
| [packages/components/src/utils/getTextAsHtml.ts](/packages/components/src/utils/getTextAsHtml.ts) | TypeScript | -41 | -1 | -9 | -51 |
| [packages/components/src/utils/index.ts](/packages/components/src/utils/index.ts) | TypeScript | -10 | 0 | -1 | -11 |
| [packages/components/src/utils/orderedListSchemaBuilder.ts](/packages/components/src/utils/orderedListSchemaBuilder.ts) | TypeScript | -29 | 0 | -2 | -31 |
| [packages/components/src/utils/unorderedListSchemaBuilder.ts](/packages/components/src/utils/unorderedListSchemaBuilder.ts) | TypeScript | -19 | 0 | -2 | -21 |
| [packages/components/tailwind.config.js](/packages/components/tailwind.config.js) | JavaScript | -27 | -4 | -2 | -33 |
| [packages/components/tsconfig.build.json](/packages/components/tsconfig.build.json) | JSON | -10 | 0 | -1 | -11 |
| [packages/components/tsconfig.json](/packages/components/tsconfig.json) | JSON with Comments | -40 | -13 | -5 | -58 |
| [packages/components/tsconfig.module.build.json](/packages/components/tsconfig.module.build.json) | JSON | -10 | 0 | -1 | -11 |
| [packages/components/tsconfig.module.json](/packages/components/tsconfig.module.json) | JSON | -9 | 0 | -1 | -10 |
| [packages/components/vite.config.js](/packages/components/vite.config.js) | JavaScript | -11 | -1 | -2 | -14 |
| [tooling/build/README.md](/tooling/build/README.md) | Markdown | -3 | 0 | -3 | -6 |
| [tooling/build/package.json](/tooling/build/package.json) | JSON | -5 | 0 | 0 | -5 |
| [tooling/build/scripts/build.sh](/tooling/build/scripts/build.sh) | Shell Script | -2 | -4 | -4 | -10 |
| [tooling/build/scripts/generate-search-index.js](/tooling/build/scripts/generate-search-index.js) | JavaScript | -57 | 0 | -11 | -68 |
| [tooling/build/scripts/generate-sitemap.js](/tooling/build/scripts/generate-sitemap.js) | JavaScript | -231 | -6 | -41 | -278 |
| [tooling/build/scripts/preBuild.sh](/tooling/build/scripts/preBuild.sh) | Shell Script | -12 | -18 | -15 | -45 |
| [tooling/eslint/base.js](/tooling/eslint/base.js) | JavaScript | -86 | -5 | -4 | -95 |
| [tooling/eslint/nextjs.js](/tooling/eslint/nextjs.js) | JavaScript | -14 | -1 | -2 | -17 |
| [tooling/eslint/package.json](/tooling/eslint/package.json) | JSON | -34 | 0 | -1 | -35 |
| [tooling/eslint/react.js](/tooling/eslint/react.js) | JavaScript | -21 | -1 | -2 | -24 |
| [tooling/eslint/tsconfig.json](/tooling/eslint/tsconfig.json) | JSON with Comments | -8 | 0 | -1 | -9 |
| [tooling/eslint/types.d.ts](/tooling/eslint/types.d.ts) | TypeScript | -43 | -5 | -11 | -59 |
| [tooling/github/package.json](/tooling/github/package.json) | JSON | -3 | 0 | -1 | -4 |
| [tooling/github/setup/action.yml](/tooling/github/setup/action.yml) | YAML | -15 | 0 | -5 | -20 |
| [tooling/prettier/index.js](/tooling/prettier/index.js) | JavaScript | -28 | -4 | -2 | -34 |
| [tooling/prettier/package.json](/tooling/prettier/package.json) | JSON | -23 | 0 | -1 | -24 |
| [tooling/prettier/tsconfig.json](/tooling/prettier/tsconfig.json) | JSON with Comments | -8 | 0 | -1 | -9 |
| [tooling/template/README.md](/tooling/template/README.md) | Markdown | -5 | 0 | -5 | -10 |
| [tooling/template/app/[[...permalink]]/page.tsx](/tooling/template/app/%5B%5B...permalink%5D%5D/page.tsx) | TypeScript JSX | -92 | -14 | -17 | -123 |
| [tooling/template/app/layout.tsx](/tooling/template/app/layout.tsx) | TypeScript JSX | -17 | 0 | -6 | -23 |
| [tooling/template/app/not-found.tsx](/tooling/template/app/not-found.tsx) | TypeScript JSX | -64 | -8 | -6 | -78 |
| [tooling/template/app/robots.ts](/tooling/template/app/robots.ts) | TypeScript | -22 | -2 | -3 | -27 |
| [tooling/template/app/sitemap.ts](/tooling/template/app/sitemap.ts) | TypeScript | -6 | -2 | -2 | -10 |
| [tooling/template/data/config.json](/tooling/template/data/config.json) | JSON | -20 | 0 | -1 | -21 |
| [tooling/template/data/footer.json](/tooling/template/data/footer.json) | JSON | -64 | 0 | -1 | -65 |
| [tooling/template/data/navbar.json](/tooling/template/data/navbar.json) | JSON | -86 | 0 | -1 | -87 |
| [tooling/template/eslint.config.mjs](/tooling/template/eslint.config.mjs) | JavaScript | -11 | -4 | -2 | -17 |
| [tooling/template/next.config.mjs](/tooling/template/next.config.mjs) | JavaScript | -8 | -2 | -2 | -12 |
| [tooling/template/package.json](/tooling/template/package.json) | JSON | -33 | 0 | -1 | -34 |
| [tooling/template/postcss.config.js](/tooling/template/postcss.config.js) | JavaScript | -6 | 0 | -1 | -7 |
| [tooling/template/public/images/isomer-logo.svg](/tooling/template/public/images/isomer-logo.svg) | SVG | -41 | 0 | -1 | -42 |
| [tooling/template/schema/about.json](/tooling/template/schema/about.json) | JSON | -48 | 0 | -1 | -49 |
| [tooling/template/schema/index.json](/tooling/template/schema/index.json) | JSON | -56 | 0 | -1 | -57 |
| [tooling/template/sitemap.json](/tooling/template/sitemap.json) | JSON | -16 | 0 | -1 | -17 |
| [tooling/template/styles/globals.css](/tooling/template/styles/globals.css) | CSS | -3 | 0 | -1 | -4 |
| [tooling/template/tailwind.config.js](/tooling/template/tailwind.config.js) | JavaScript | -26 | -1 | -4 | -31 |
| [tooling/template/tsconfig.json](/tooling/template/tsconfig.json) | JSON with Comments | -20 | 0 | -1 | -21 |
| [tooling/typescript/base.json](/tooling/typescript/base.json) | JSON | -22 | -4 | -4 | -30 |
| [tooling/typescript/internal-package.json](/tooling/typescript/internal-package.json) | JSON | -10 | -1 | -1 | -12 |
| [tooling/typescript/package.json](/tooling/typescript/package.json) | JSON | -8 | 0 | 0 | -8 |
| [turbo.json](/turbo.json) | JSON | -45 | 0 | -1 | -46 |
