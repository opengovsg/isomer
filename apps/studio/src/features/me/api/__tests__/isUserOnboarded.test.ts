...
describe("isUserOnboarded", () => {
  ...
  describe("phone number validation", () => {
    ...
    it("should return false for numbers with incorrect length", () => {
      // Arrange
      const invalidUsers = [
        { name: "Test User", phone: "912345" },
        // Too short (6 digits)
        { name: "Test User", phone: "9123456" },
        // Too short (7 digits)
        { name: "Test User", phone: "912345678" },
        // Too long (9 digits)
        { name: "Test User", phone: "9123456789" },
        // Too long (10 digits)
      ]
    ...
    it("should return false for non-numeric inputs", () => {
      // Arrange
      const invalidUsers = [
        { name: "Test User", phone: "abcdefgh" },
        // Letters
        { name: "Test User", phone: "9123456a" },
        // Mix of numbers and letters
        { name: "Test User", phone: "91234-67" },
        // With hyphen
        { name: "Test User", phone: "9123 456" },
        // With space
    ...
    it("should return false for empty or invalid inputs", () => {
      ...
      const invalidUsers = [
        ...
        // String "null"
        { name: "Test User", phone: "undefined" },
        // String "undefined"
      ]
    ...
    it("should return false for inputs with whitespace and formatting quirks", () => {
      ...
      const invalidUsers = [
        ...
        { name: "Test User", phone: "91234567\n" },
        // Newline
        { name: "Test User", phone: "\r91234567" },
        // Carriage return
        { name: "Test User", phone: "9 1234567" },
        // Space in middle
        { name: "Test User", phone: "912 34567" },
        // Space in middle
        { name: "Test User", phone: "9123 4567" },
        // Space in middle
        { name: "Test User", phone: "91234 567" },
        // Space in middle
        { name: "Test User", phone: "912345 67" },
        // Space in middle
        { name: "Test User", phone: "9123456 7" },
        // Space in middle
      ]
