...
const REPORT_TYPE_OPTIONS = [
  { value: AuditLogExportReportType.Access, label: "Access report" },
  { value: AuditLogExportReportType.Activity, label: "Activity report" },
  { value: AuditLogExportReportType.Both, label: "Both" },
]
