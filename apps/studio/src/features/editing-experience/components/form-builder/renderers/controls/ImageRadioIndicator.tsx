...
const SelectedBlueCircle = ({
  filterId,
  ...props
}: { filterId: string } & React.SVGProps<SVGSVGElement>) => (
  <svg
...
export const ImageRadioIndicator = chakra(
  ({
    ...
    if (isSelected) {
      return <SelectedBlueCircle filterId={filterId} {...props} />
    }

    return <UnselectedPlainCircle filterId={filterId} {...props} />
  },
)
