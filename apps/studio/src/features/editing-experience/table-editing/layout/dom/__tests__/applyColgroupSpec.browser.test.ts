...
import { applyColgroupSpec } from "../applyColgroupSpec"

describe("applyColgroupSpec", () => {
  it("should create a colgroup with percentage widths", () => {
    // Arrange
    const table = document.createElement("table")

    // Act
    applyColgroupSpec(table, [50, 30, 20])
  ...
  it("should rebuild colgroup when column count changes", () => {
    // Arrange
    const table = document.createElement("table")
    applyColgroupSpec(table, [50, 50])

    // Act
    applyColgroupSpec(table, [34, 33, 33])
