import { Text, TableContainer, Table, Thead, Tr, Th, Checkbox, HStack, Tbody, Td, VStack, Badge, IconButton, Box } from "@chakra-ui/react"
import { Pagination } from "@opengovsg/design-system-react"
import { useState } from "react"
import { BiHome, BiFileBlank, BiFolder, BiSolidCircle, BiDotsHorizontalRounded } from "react-icons/bi"
                        ...
                        {element.type === 'page' &&
                          element.status == 'published' && (
                            <Badge
                              ...
                              borderRadius="50px"
                            >
                              <BiSolidCircle fill="#0F796F" style={{ marginRight: '.25rem' }} />
                              Published
                            </Badge>
                          )}
